...
int main(){
  ...
  std::ifstream fin;
  std::string str;
  fin.open("C:/Users/vanderson.borborema.110/Desktop/Projeto/Arquivos/figura.txt");
  if(!fin.is_open()){
    std::exit(0);
  }
  ...
  s->writeOFF("C:/Users/vanderson.borborema.110/Desktop/Projeto/Arquivos/testetrono.off");
